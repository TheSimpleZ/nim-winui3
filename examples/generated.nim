...
##
## ```
## nim c -r --path:src --outdir:bin examples/generated.nim
## ```

from winui3 import start
...
start(proc() =
  ...
  subtitle.text = "Every class, property and event here came " &
                  "from Microsoft.UI.Xaml.winmd"
